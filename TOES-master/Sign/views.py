    ...
    try:
        if request.method == 'POST':
            ...
            # post login details to this api
                url = 'http://tcp-api.herokuapp.com/token/login/'
            ...
            user_info_api = 'http://tcp-api.herokuapp.com/users/me/'
            ...
            try:
                url = 'http://tcp-api.herokuapp.com/token/logout/'
...
def sign_up(request):
    if request.method == 'POST':
            ...
            create_user_api = 'http://tcp-api.herokuapp.com/users/'
...
def home(request):
    if AUTH_TOKEN == None:
        ...
        url = 'http://tcp-api.herokuapp.com/api/worker_count/'
...
def create(request):
    if AUTH_TOKEN == None:
        ...
        if request.method == 'POST':
                ...
                url = 'http://tcp-api.herokuapp.com/worker/'
...
def phone_disp(request):
    if AUTH_TOKEN == None:
        ...
        url = 'http://tcp-api.herokuapp.com/api/withoutsmartphone/'
...
def recruiters(request):
    if AUTH_TOKEN == None:
        ...
        url = 'http://tcp-api.herokuapp.com/job/'
        response = requests.get(url , headers = {'Authorization' : AUTH_TOKEN})
        response = response.json()
...
def workers(request):
    if AUTH_TOKEN == None:
        ...
        url = 'http://tcp-api.herokuapp.com/api/allcategories/'
        json_data={}
        response = requests.get(url , headers={'Authorization': AUTH_TOKEN})
        response=response.json()
...
def workerpainter(request):
    if AUTH_TOKEN == None:
        ...
        url = 'http://tcp-api.herokuapp.com/api/category/painter/'
        response = requests.get(url , headers={'Authorization': AUTH_TOKEN})
        response=response.json()
...
def workerplumber(request):
    if AUTH_TOKEN == None:
        ...
        url = 'http://tcp-api.herokuapp.com/api/category/plumber/'
        response = requests.get(url , headers={'Authorization': AUTH_TOKEN})
        response=response.json()
        return render(request , 'Sign/workerplumber.html',{'response':response})

def delete(request,id):
    url = f'http://tcp-api.herokuapp.com/api/delete/{id}'
    response = requests.get(url , headers={'Authorization': AUTH_TOKEN})
    return redirect('allusers')


def block(request,id):
    url = f'http://tcp-api.herokuapp.com/api/block/1/{id}'
    response = requests.get(url , headers={'Authorization': AUTH_TOKEN})
    return redirect('allusers')

def unblock(request,id):
    url = f'http://tcp-api.herokuapp.com/api/block/0/{id}'
    response = requests.get(url , headers={'Authorization': AUTH_TOKEN})
    return redirect('allusers')
...
def allusers(request):
    if AUTH_TOKEN == None:
        ...
        url = 'http://tcp-api.herokuapp.com/users/'
        response = requests.get(url , headers={'Authorization': AUTH_TOKEN})
        response=response.json()
...
#     url = 'http://tcp-api.herokuapp.com/users/me/'
#     response = requests.get(url , headers={'Authorization':AUTH_TOKEN})
#     response=response.json()
...
def driver(request):
    if AUTH_TOKEN == None:
        ...
        url = 'http://tcp-api.herokuapp.com/api/category/driver/'
        response = requests.get(url , headers={'Authorization': AUTH_TOKEN})
        response=response.json()
...
def electrician(request):
    if AUTH_TOKEN == None:
        ...
        url = 'http://tcp-api.herokuapp.com/api/category/electrician/'
        response = requests.get(url , headers={'Authorization': AUTH_TOKEN})
        response=response.json()
...
def carpenter(request):
    if AUTH_TOKEN == None:
        ...
        url = 'http://tcp-api.herokuapp.com/api/category/carpenter/'
        response = requests.get(url , headers={'Authorization': AUTH_TOKEN})
        response=response.json()
